...
public class GagalTestMenengahActivity extends AppCompatActivity {
    Button mBtnCobaLagi;
    Users mUsers;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gagal_test_menengah);
        ...
        mBtnCobaLagi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(GagalTestMenengahActivity.this, MainActivity.class);
