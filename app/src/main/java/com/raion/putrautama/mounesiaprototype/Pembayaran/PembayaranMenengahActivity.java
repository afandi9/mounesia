...
public class PembayaranMenengahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pembayaran_menengah);
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(PembayaranMenengahActivity.this,BookingMenengahActivity.class);
        ...
        mBtnBCA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(PembayaranMenengahActivity.this,TransferBCAActivity.class);
        ...
        mBtnBRI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(PembayaranMenengahActivity.this,TransferBRIActivity.class);
                intent.putExtra("PESANAN",mPesanan);
                intent.putExtra("USER", mUsers);
                startActivity(intent);
            }
        ...
        mBtnMandiri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(PembayaranMenengahActivity.this,TransferMandiriActivity.class);
                intent.putExtra("PESANAN",mPesanan);
                intent.putExtra("USER", mUsers);
                startActivity(intent);
            }
        ...
        mBtnBNI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(PembayaranMenengahActivity.this,TransferBNIActivity.class);
                intent.putExtra("PESANAN",mPesanan);
                intent.putExtra("USER", mUsers);
                startActivity(intent);
            }
