...
public class TransferBRIActivity extends AppCompatActivity {
    Users mUsers;
    Bank mBank;
    Pesanan mPesanan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transfer_bri);
...
//                writePesananToDatabase();
                Intent intent = new Intent(TransferBRIActivity.this, TicketActivity.class);
