...
public class BookingPemulaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_pemula);
...
//                , String catatanTambahan
        Pesanan pesanan = new Pesanan(gunungPemula.getNamaGunungPemula()
                ,gunungPemula.getLokasiGunungPemula()
                ,gunungPemula.getSuhuGunungPemula()
                ,gunungPemula.getDeskripsiGunungPemula()
                ,gunungPemula.getBarangGunungPemula()
                ,gunungPemula.getKetinggianGunungPemula()
                ,gunungPemula.getRuteGunungPemula()
                ,gunungPemula.getPaketGunungPemula()
                ,jumlahOrang*gunungPemula.getHargaGunungPemula()
                ,gunungPemula.getFotoGunungPemula()
                ,nama
                ,notlp
                ,email
                ,tglBooking
    ...
    private void Booking(){
        ...
        Intent intent = new Intent(BookingPemulaActivity.this, PembayaranPemulaActivity.class);
