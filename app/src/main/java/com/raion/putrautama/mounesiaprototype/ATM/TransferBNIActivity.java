...
public class TransferBNIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transfer_bni);
...
//                writePesananToDatabase();
                Intent intent = new Intent(TransferBNIActivity.this, TicketActivity.class);
